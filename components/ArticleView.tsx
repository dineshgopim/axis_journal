  ...
  return (
    <article className="animate-in fade-in duration-700">
      ...
      <header className="mb-20 text-center">
        ...
        <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-black leading-[1.1] text-axis-charcoal mb-12 tracking-tight">
          {article.title}
        </h1>
        
        <p className="font-body text-xl md:text-2xl text-gray-500 leading-relaxed italic mb-16 max-w-4xl mx-auto">
          {article.subtitle}
        </p>

        <div className="flex flex-col items-center justify-center py-12 border-y border-axis-charcoal/5">
      ...
      <div className="w-full">
        <div className="font-body text-[1.15rem] md:text-[1.3rem] leading-[1.85] text-gray-800 space-y-12 selection:bg-axis-maroon/10 selection:text-axis-charcoal">
          {article.content.map((block, index) => {
            switch (block.type) {
              case 'paragraph':
                ...
                if (isContentNote) {
                  return (
                    <div key={index} className="bg-axis-gray/50 border-l-[4px] border-axis-maroon p-10 my-16 shadow-sm ring-1 ring-black/5">
                      <p className="font-sans text-[10px] uppercase font-bold tracking-[0.5em] text-axis-maroon mb-6">Editorial Note</p>
              ...
              case 'subheading':
                return (
                  <h2 key={index} className="font-serif text-3xl md:text-4xl font-black text-axis-navy pt-20 pb-4 tracking-tight leading-snug text-center italic">
                    {block.content}
                  </h2>
                );
              ...
              case 'list':
                return (
                   <div key={index} className="bg-white border-y border-axis-charcoal/10 p-12 md:p-20 my-24">
                     <h4 className="font-sans font-bold text-[10px] uppercase tracking-[0.6em] text-gray-400 mb-16 text-center">Referenced Scholarly Sources</h4>
                     <ul className="space-y-8 font-body text-base text-gray-600 max-w-3xl mx-auto">
                        {block.items?.map((item, i) => (
                          <li key={i} className="group flex items-start gap-6 border-b border-axis-charcoal/5 pb-6 last:border-0">
        ...
        {/* Footer Engagement */}
        <div className="mt-40 pt-24 border-t border-axis-charcoal/10 flex flex-col items-center">
          ...
          <div className="w-24 h-px bg-axis-charcoal/10 mb-16"></div>
          <div className="text-center">
            <h5 className="font-serif italic text-2xl text-axis-charcoal mb-10">In pursuit of scholarly clarity.</h5>
